...
#     analysis_processor.get_answer(history_record)
    analysis_processor.run_processor_tests(history_record)
...
def run_postprocessing(postprocessing_commands):
    global history_record
    if not history_record:
        raise Exception('The postprocessing command was attempted before training was run.  Please run training first!')
    # This code is customized according to the needs of your particular project.
    ...
    analysis_processor.run_preprocessing_commands(postprocessing_commands)
